...
> **Note**: For general secrets management overview and alternative secret sources, see [docs/ops/24-secrets-management-guide.md](24-secrets-management-guide.md).
