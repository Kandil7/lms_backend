...
class InstructorService:
    ...
    def update_instructor_profile(
        self, user_id: UUID, update_data: InstructorUpdate
    ) -> Instructor:
    ...
    def get_onboarding_status(self, user_id: UUID) -> dict:
        ...
        return {
            "step": "complete" if is_complete else "verification" if "verification" in completed_steps else "profile" if "profile" in completed_steps else "account_setup",
