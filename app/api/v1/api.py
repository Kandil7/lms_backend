...
# Always include token-based auth router for compatibility (OAuth2, Swagger, API clients).
_safe_include(api_router, "app.modules.auth.router:router")

# Include cookie-based auth endpoints in production.
...
_safe_include(api_router, "app.modules.certificates.routers.certificate_public_router:router")
_safe_include(api_router, "app.modules.assignments.routers:router")
_safe_include(api_router, "app.modules.payments.routers.payment_router:router")
_safe_include(api_router, "app.modules.admin.router:router")
_safe_include(api_router, "app.modules.instructors.router:router")
_safe_include(api_router, "app.modules.websocket.routers.websocket_router:router")
